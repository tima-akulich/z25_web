"""
Django settings for amazing_shop project.
...
MIDDLEWARE = [
    'shop.middleware.my_exception_middleware',
    'shop.middleware.ServerErrorMiddleware',
...
WSGI_APPLICATION = 'amazing_shop.wsgi.application'
